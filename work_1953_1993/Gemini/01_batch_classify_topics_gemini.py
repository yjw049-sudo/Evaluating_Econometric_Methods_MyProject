...
Recommended chunked workflow:
    python 01_batch_classify_topics_gemini.py make-chunks --chunk-size 2000
...
TEXT_COLUMN = "speechtext_oringinal"
TEXT_COLUMN_ALIASES = ["speechtext_oringinal", "speechtext_original", "speechtext"]
