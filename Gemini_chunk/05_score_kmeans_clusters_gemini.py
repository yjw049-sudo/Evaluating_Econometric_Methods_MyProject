...
Usage:
    ...
    python 05_score_kmeans_clusters_gemini.py --input ../Kmeans/Kmeans_chunk/cluster_summary.csv
"""
...
DEFAULT_INPUT_PATH = ROOT.parent / "Kmeans" / "Kmeans_chunk" / "cluster_summary.csv"
